<template>
	<view class="content">
	    <view class="header">
	        <view class="title mtitle" :style="'color:'+template.color.color2">{{addressData.id?'编辑':'新增'}}地址
	        	<icon class="circular" type="crilce" size="10" :color="template.color.color1"></icon>
	        </view>
	    </view>
		<view class="formBox">
			<view class="label lineBottom">
				<view class="title" :style="'color:'+template.color.color2">联系人</view>
				<view class="input">
					<input type="text" v-model="addressData.cname" placeholder="请输入收货人姓名" :style="'color:'+template.color.color2" />
				</view>
			</view>
			<view class="label lineBottom">
				<view class="title" :style="'color:'+template.color.color2">手机号</view>
				<view class="input">
					<input type="number" v-model="addressData.phone" placeholder="请输入联系手机号码" :style="'color:'+template.color.color2" />
				</view>
			</view>
			<view class="label lineBottom">
				<view class="title" :style="'color:'+template.color.color2">身份证</view>
				<view class="input">
					<input type="number" v-model="addressData.idcard" placeholder="如需要海关报关则必填" :style="'color:'+template.color.color2" />
				</view>
			</view>
			<view class="label lineBottom">
				<view class="title" :style="'color:'+template.color.color2">所属区域</view>
				<view class="input">
			...
			<view class="label lineBottom">
				<view class="title" :style="'color:'+template.color.color2">街道信息</view>
				<view class="input">
